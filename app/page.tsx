    ...
    <main className="bg-[#1A202C] text-white">
          ...
          <div className="md:w-1/2 mb-8 md:mb-0 text-center md:text-left">
            ...
            <div className="flex flex-col sm:flex-row justify-center md:justify-start gap-4">
              ...
              <Link
                ...
                className="border border-green-500 text-green-500 px-6 py-3 rounded-lg hover:bg-green-500 hover:text-white transition-colors text-center"
              >
                Make a Vote
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-[#2D3748] p-6 rounded-lg flex flex-col items-center"
              >
                <div className="mb-4">
                  <svg
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6">
            {[1, 2, 3, 4].map((i) => (
              <div
                key={i}
                className="bg-gray-300 h-40 sm:h-48 flex items-center justify-center rounded-lg"
              >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="bg-gray-300 h-32 flex items-center justify-center rounded-lg"
              >
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link
            href="/get-started"
            className="bg-green-500 text-white px-6 py-3 rounded-lg hover:bg-green-600 transition-colors inline-flex items-center justify-center"
          >
            Get Started
            <svg
